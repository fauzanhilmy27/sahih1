...
<style>
    ...
    .short-input {
        width: 400px; /* Atur lebar input sesuai kebutuhan */
    }
    .solid-box {
        ...
        margin-left: -50px; /* Posisikan ke kanan */
        margin-right: -50px; /* Posisikan ke kiri */
    }
        ...
        <form action="PosDugaAir_Proses_Tambah.php" method="POST" onsubmit="return validateForm()">
            <div class="row">
                ...
                <div class="mb-3">
                        ...
                        <input type="text" class="form-control short-input" id="id" name="id" value="<?php echo $row["id"]; ?>" readonly require></input>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control short-input" id="mercu" name="mercu" value="<?php echo $row['mercu']; ?>" require></input>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control short-input" id="TipePos" name="TipePos" value="<?php echo $row["TipePos"]; ?>" require></input>
                    </div>
                    <div class="mb-3">
                        <label for="TanggalPemasangan" class="form-label">Tanggal Pemasangan:</label>
                        <input type="date" class="form-control short-input" id="TanggalPemasangan" name="TanggalPemasangan" value="<?php echo $row["TanggalPemasangan"]; ?>" require></input>
                    </div>
                    <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control short-input" id="lon" name="lon" value="<?php echo $row["lon"]; ?>" require></input>
                    </div>
                    <div class="mb-3">
                        ...
                        <option value="<?php echo $row["Provinsi"]; ?>">Pilih Provinsi</option>
                        </select></input>
                    </div>
                    <div class="mb-3">
